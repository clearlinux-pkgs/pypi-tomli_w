...
Source0  : https://files.pythonhosted.org/packages/19/75/241269d1da26b624c0d5e110e8149093c759b7a286138f4efd61a60e75fe/tomli_w-1.2.0.tar.gz
...
%prep
%setup -q -n tomli_w-1.2.0
cd %{_builddir}/tomli_w-1.2.0
pushd ..
cp -a tomli_w-1.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736954065
